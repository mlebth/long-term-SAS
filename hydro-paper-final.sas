...
data seed; set seedlings4; keep bcat burnsev burn soil year heig hydrn coun plot sspp;  
...
*---- # of obs of each plot -------------------;
proc sort data=seed; by plot hydromulch burnsev soil;
proc means data=seed noprint n; by plot hydromulch burnsev soil;
...
run;
proc means data=pita sum noprint; by plot burnsev burn bcat hydromulch soil; 
...
run;
proc means data=quma sum noprint; by plot burnsev hydromulch soil; 
...
run;
proc means data=quma3 sum noprint; by plot burnsev hydromulch soil; 
