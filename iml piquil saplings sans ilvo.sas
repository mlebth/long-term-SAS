...
data holdxxxxx; set piquilsap2; if (subp = 'sapl') 				   & (sspp = 'XXXXx'); nquma3 = nperspp; 
data holdxxxxx; set piquilsap2; if (subp = 'sapl') 				   & (sspp = 'XXXXx'); nqumax = nperspp; 
data holdxxxxx; set piquilsap2; if (subp = 'sapl') 				   & (sspp = 'XXXXx'); npitax = nperspp; 
