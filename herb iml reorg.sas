...
proc sort data=dat1n; by plot quad coun; run;
proc means data=dat1n noprint mean; by plot quad coun; var plot quad coun;
	output out=dat2n mean=mplot mquad mcoun; run;
	proc print data=dat2n; run;
...
use dat1n; read all into matnum;				*print matnum;	 *12 columns, 12548 rows (150,576 cells);

*reading in character data;
use dat1c; read all var _char_ into matchar;	*print matchar;
