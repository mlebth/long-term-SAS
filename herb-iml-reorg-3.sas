...
matnumdat=j(nrecords,15,9999); 					*print matcount; *15 columns, 12548 rows;
...
nobs=nrow(matnumdat);							*print nobs; *12548;
...
matspid=j(nrecords,nsp,9999); 					*print matcount; *315 columns, 12548 rows;
do i=1 to nrecords;
	uniquad=10*(matnum[i,1]-1)+ matnum[i,2];	*unique quadrat id;
	spid='WARNx';
	matspid[uniquad,spid]=matnum[i,3];
end;
* print (matspid[1:20,]);
