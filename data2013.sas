...
*--------------------------------------- seedlings -----------------------------------------------------;
proc import datafile="F:\Excel Files\2013 Raw data\final data\seedlings2013.csv"
out=seedling (keep=plot sspp snum shgt)
dbms=csv replace;
getnames=yes;
run;
...
*--------------------------------------- overstory -----------------------------------------------------;
proc import datafile="F:\Excel Files\2013 Raw data\final data\overstory2013.csv"
...
*--------------------------------------- pole trees -----------------------------------------------------;
proc import datafile="F:\Excel Files\2013 Raw data\final data\poletrees2013.csv"
...
*--------------------------------------- herbaceous -----------------------------------------------------;
proc import datafile="F:\Excel Files\2013 Raw data\final data\herbaceous2013.csv"
...
proc glm data=herbs4;
  ...
  *model sumstems = bcat1 yrcat bcat1*yrcat; *p=0.0009;
  model mstems = burn yrcat burn*yrcat; *p=0.0041, normal by S-W;
  lsmeans bcat2*yrcat / stderr;
  means burn yrcat / alpha=0.05 tukey cldiff;
  output out=glmout1 r=ehat;
run;
proc univariate data=glmout1 plot normal; var ehat;
run;
...
*--------------------------------------- transect -----------------------------------------------------;
proc import datafile="F:\Excel Files\2013 Raw data\final data\transect2013.csv"
...
*--------------------------------------- shrubs -----------------------------------------------------;
proc import datafile="F:\Excel Files\2013 Raw data\final data\shrubs2013.csv"
...
proc glm data=shrubs4;
  ...
  *model logsumstems = bcat2 yrcat bcat2*yrcat; *p=0.178. much better fit on all log transformed data;
  model logsumstems = bcat1 yrcat bcat1*yrcat; *p=0.0533;
  lsmeans bcat1*yrcat / stderr;
  output out=glmout1 r=ehat;
run;
...
*--------------------------------------- canopy cover -----------------------------------------------------;
proc import datafile="F:\Excel Files\2013 Raw data\final data\canopycover2013.csv"
...
proc import datafile="G:\Excel Files\2012 data\data2012.xls"
