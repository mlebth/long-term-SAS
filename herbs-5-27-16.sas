...
*structure 2;
proc sort data=herbspost; by plot bcat elev hydr slope soil aspect;	run;
*mean counts per plot (instead of per quad);
proc means data=herbspost n mean noprint; by plot bcat elev hydr slope soil aspect; 
	var caco 	quad	ANGL2	KRVIx	COERx	PABR2	WAMAx	PASEC	ARPUP	DITE2	SOEL3	NUCAx	CITE2	PHAM4	TRUR2	
PAPE5	CRGL2	PAHI1	CHTE1	PSOB3	SPCO1	FRFLx	NELU2	DICO6	JUBRx	COBA2	DIOLS	JUTEx	DICA3	ERSEx
GYAMx	STPI3	LEHI2	CRSA4	ERINx	ANVI2	HERO2	CAMU4	TRBI2	DIACx	TRPE4	PTAQx	DIRAx	LERE2	PHCI4
SPCLx	FIPUx	CALE6	HYDRx	CRMO6	CYHYx	SONU2	NUTEx	HYGL2	TRRA5	JUMA4	ACGR2	PASE5	CYCR6	EUCO7
...
mDIAN4	mERSPx	mCYRE5	mCAMI8	mSCCIx	mLEDUx	mCOCA5	mLETEx	mPOPR4	mDISP2	mHELA5	mDIOLx	mDILI2	mSILIx;
run; *n=46;
* proc print data=mquadpost; title 'mquadpost'; run;

data dat2012; set mquadpost; if year=2012; 
	 rename caco=cov12 quad=quad12 ANGL2=ANGL212	KRVIx=KRVIx12	COERx=COERx12	PABR2=PABR212	WAMAx=WAMAx12	PASEC=PASEC12	
ARPUP=ARPUP12	DITE2=DITE212	SOEL3=SOEL312	NUCAx=NUCAx12	CITE2=CITE212	PHAM4=PHAM412	TRUR2=TRUR212	
PAPE5=PAPE512	CRGL2=CRGL212	PAHI1=PAHI112	CHTE1=CHTE112	PSOB3=PSOB312	SPCO1=SPCO112	FRFLx=FRFLx12	
NELU2=NELU212	DICO6=DICO612	JUBRx=JUBRx12	COBA2=COBA212	DIOLS=DIOLS12	JUTEx=JUTEx12	DICA3=DICA312	
ERSEx=ERSEx12	GYAMx=GYAMx12	STPI3=STPI312	LEHI2=LEHI212	CRSA4=CRSA412	ERINx=ERINx12	ANVI2=ANVI212	
HERO2=HERO212	CAMU4=CAMU412	TRBI2=TRBI212	DIACx=DIACx12	TRPE4=TRPE412	PTAQx=PTAQx12	DIRAx=DIRAx12	
LERE2=LERE212	PHCI4=PHCI412	SPCLx=SPCLx12	FIPUx=FIPUx12	CALE6=CALE612	HYDRx=HYDRx12	CRMO6=CRMO612	
CYHYx=CYHYx12	SONU2=SONU212	NUTEx=NUTEx12	HYGL2=HYGL212	TRRA5=TRRA512	JUMA4=JUMA412	ACGR2=ACGR212	
PASE5=PASE512	CYCR6=CYCR612	EUCO7=EUCO712	CYLU2=CYLU212	ARLO1=ARLO112	BUCA2=BUCA212	EUSEx=EUSEx12	
EUCO1=EUCO112	GAREx=GAREx12	CEVI2=CEVI212	DISC3=DISC312	VUOCx=VUOCx12	BUCIx=BUCIx12	CYEC2=CYEC212	
AGHYx=AGHYx12	DIOVx=DIOVx12	HEGEx=HEGEx12	DIAC2=DIAC212	GAPE2=GAPE212	OXDI2=OXDI212	CRDI1=CRDI112	
DIVI7=DIVI712	CHPI8=CHPI812	RHHAx=RHHAx12	GAAN1=GAAN112	ARDE3=ARDE312	SCSCx=SCSCx12	LEMU3=LEMU312	
SEARx=SEARx12	PAPL3=PAPL312	GAAR1=GAAR112	DIAN4=DIAN412	ERSPx=ERSPx12	CYRE5=CYRE512	CAMI8=CAMI812	
SCCIx=SCCIx12	LEDUx=LEDUx12	COCA5=COCA512	LETEx=LETEx12	POPR4=POPR412	DISP2=DISP212	HELA5=HELA512	
DIOLx=DIOLx12	DILI2=DILI212	SILIx=SILIx12;  
data dat2013; set mquadpost; if year=2013; 
	 rename caco=cov13 quad=quad13 ANGL2=ANGL213	KRVIx=KRVIx13	COERx=COERx13	PABR2=PABR213	WAMAx=WAMAx13	
PASEC=PASEC13	ARPUP=ARPUP13	DITE2=DITE213	SOEL3=SOEL313	NUCAx=NUCAx13	CITE2=CITE213	PHAM4=PHAM413
TRUR2=TRUR213	PAPE5=PAPE513	CRGL2=CRGL213	PAHI1=PAHI113	CHTE1=CHTE113	PSOB3=PSOB313	SPCO1=SPCO113
FRFLx=FRFLx13	NELU2=NELU213	DICO6=DICO613	JUBRx=JUBRx13	COBA2=COBA213	DIOLS=DIOLS13	JUTEx=JUTEx13	
DICA3=DICA313	ERSEx=ERSEx13	GYAMx=GYAMx13	STPI3=STPI313	LEHI2=LEHI213	CRSA4=CRSA413	ERINx=ERINx13	
ANVI2=ANVI213	HERO2=HERO213	CAMU4=CAMU413	TRBI2=TRBI213	DIACx=DIACx13	TRPE4=TRPE413	PTAQx=PTAQx13	
DIRAx=DIRAx13	LERE2=LERE213	PHCI4=PHCI413	SPCLx=SPCLx13	FIPUx=FIPUx13	CALE6=CALE613	HYDRx=HYDRx13	
CRMO6=CRMO613	CYHYx=CYHYx13	SONU2=SONU213	NUTEx=NUTEx13	HYGL2=HYGL213	TRRA5=TRRA513	JUMA4=JUMA413	
ACGR2=ACGR213	PASE5=PASE513	CYCR6=CYCR613	EUCO7=EUCO713	CYLU2=CYLU213	ARLO1=ARLO113	BUCA2=BUCA213	
EUSEx=EUSEx13	EUCO1=EUCO113	GAREx=GAREx13	CEVI2=CEVI213	DISC3=DISC313	VUOCx=VUOCx13	BUCIx=BUCIx13	
CYEC2=CYEC213	AGHYx=AGHYx13	DIOVx=DIOVx13	HEGEx=HEGEx13	DIAC2=DIAC213	GAPE2=GAPE213	OXDI2=OXDI213	
CRDI1=CRDI113	DIVI7=DIVI713	CHPI8=CHPI813	RHHAx=RHHAx13	GAAN1=GAAN113	ARDE3=ARDE313	SCSCx=SCSCx13	
LEMU3=LEMU313	SEARx=SEARx13	PAPL3=PAPL313	GAAR1=GAAR113	DIAN4=DIAN413	ERSPx=ERSPx13	CYRE5=CYRE513	
CAMI8=CAMI813	SCCIx=SCCIx13	LEDUx=LEDUx13	COCA5=COCA513	LETEx=LETEx13	POPR4=POPR413	DISP2=DISP213	
HELA5=HELA513	DIOLx=DIOLx13	DILI2=DILI213	SILIx=SILIx13	; 
data dat2014; set mquadpost; if year=2014; 
	 rename caco=cov14 quad=quad14 ANGL2=ANGL214	KRVIx=KRVIx14	COERx=COERx14	PABR2=PABR214	WAMAx=WAMAx14	
PASEC=PASEC14	ARPUP=ARPUP14	DITE2=DITE214	SOEL3=SOEL314	NUCAx=NUCAx14	CITE2=CITE214	PHAM4=PHAM414
TRUR2=TRUR214	PAPE5=PAPE514	CRGL2=CRGL214	PAHI1=PAHI114	CHTE1=CHTE114	PSOB3=PSOB314	SPCO1=SPCO114
FRFLx=FRFLx14	NELU2=NELU214	DICO6=DICO614	JUBRx=JUBRx14	COBA2=COBA214	DIOLS=DIOLS14	JUTEx=JUTEx14	
DICA3=DICA314	ERSEx=ERSEx14	GYAMx=GYAMx14	STPI3=STPI314	LEHI2=LEHI214	CRSA4=CRSA414	ERINx=ERINx14	
ANVI2=ANVI214	HERO2=HERO214	CAMU4=CAMU414	TRBI2=TRBI214	DIACx=DIACx14	TRPE4=TRPE414	PTAQx=PTAQx14	
DIRAx=DIRAx14	LERE2=LERE214	PHCI4=PHCI414	SPCLx=SPCLx14	FIPUx=FIPUx14	CALE6=CALE614	HYDRx=HYDRx14	
CRMO6=CRMO614	CYHYx=CYHYx14	SONU2=SONU214	NUTEx=NUTEx14	HYGL2=HYGL214	TRRA5=TRRA514	JUMA4=JUMA414	
ACGR2=ACGR214	PASE5=PASE514	CYCR6=CYCR614	EUCO7=EUCO714	CYLU2=CYLU214	ARLO1=ARLO114	BUCA2=BUCA214	
EUSEx=EUSEx14	EUCO1=EUCO114	GAREx=GAREx14	CEVI2=CEVI214	DISC3=DISC314	VUOCx=VUOCx14	BUCIx=BUCIx14	
CYEC2=CYEC214	AGHYx=AGHYx14	DIOVx=DIOVx14	HEGEx=HEGEx14	DIAC2=DIAC214	GAPE2=GAPE214	OXDI2=OXDI214	
CRDI1=CRDI114	DIVI7=DIVI714	CHPI8=CHPI814	RHHAx=RHHAx14	GAAN1=GAAN114	ARDE3=ARDE314	SCSCx=SCSCx14	
LEMU3=LEMU314	SEARx=SEARx14	PAPL3=PAPL314	GAAR1=GAAR114	DIAN4=DIAN414	ERSPx=ERSPx14	CYRE5=CYRE514	
CAMI8=CAMI814	SCCIx=SCCIx14	LEDUx=LEDUx14	COCA5=COCA514	LETEx=LETEx14	POPR4=POPR414	DISP2=DISP214	
HELA5=HELA514	DIOLx=DIOLx14	DILI2=DILI214	SILIx=SILIx14;  
data dat2015; set mquadpost; if year=2015; 
	 rename caco=cov15 quad=quad15 ANGL2=ANGL215	KRVIx=KRVIx15	COERx=COERx15	PABR2=PABR215	WAMAx=WAMAx15	
PASEC=PASEC15	ARPUP=ARPUP15	DITE2=DITE215	SOEL3=SOEL315	NUCAx=NUCAx15	CITE2=CITE215	PHAM4=PHAM415
TRUR2=TRUR215	PAPE5=PAPE515	CRGL2=CRGL215	PAHI1=PAHI115	CHTE1=CHTE115	PSOB3=PSOB315	SPCO1=SPCO115
FRFLx=FRFLx15	NELU2=NELU215	DICO6=DICO615	JUBRx=JUBRx15	COBA2=COBA215	DIOLS=DIOLS15	JUTEx=JUTEx15	
DICA3=DICA315	ERSEx=ERSEx15	GYAMx=GYAMx15	STPI3=STPI315	LEHI2=LEHI215	CRSA4=CRSA415	ERINx=ERINx15	
ANVI2=ANVI215	HERO2=HERO215	CAMU4=CAMU415	TRBI2=TRBI215	DIACx=DIACx15	TRPE4=TRPE415	PTAQx=PTAQx15	
DIRAx=DIRAx15	LERE2=LERE215	PHCI4=PHCI415	SPCLx=SPCLx15	FIPUx=FIPUx15	CALE6=CALE615	HYDRx=HYDRx15	
CRMO6=CRMO615	CYHYx=CYHYx15	SONU2=SONU215	NUTEx=NUTEx15	HYGL2=HYGL215	TRRA5=TRRA515	JUMA4=JUMA415	
ACGR2=ACGR215	PASE5=PASE515	CYCR6=CYCR615	EUCO7=EUCO715	CYLU2=CYLU215	ARLO1=ARLO115	BUCA2=BUCA215	
EUSEx=EUSEx15	EUCO1=EUCO115	GAREx=GAREx15	CEVI2=CEVI215	DISC3=DISC315	VUOCx=VUOCx15	BUCIx=BUCIx15	
CYEC2=CYEC215	AGHYx=AGHYx15	DIOVx=DIOVx15	HEGEx=HEGEx15	DIAC2=DIAC215	GAPE2=GAPE215	OXDI2=OXDI215	
CRDI1=CRDI115	DIVI7=DIVI715	CHPI8=CHPI815	RHHAx=RHHAx15	GAAN1=GAAN115	ARDE3=ARDE315	SCSCx=SCSCx15	
LEMU3=LEMU315	SEARx=SEARx15	PAPL3=PAPL315	GAAR1=GAAR115	DIAN4=DIAN415	ERSPx=ERSPx15	CYRE5=CYRE515	
CAMI8=CAMI815	SCCIx=SCCIx15	LEDUx=LEDUx15	COCA5=COCA515	LETEx=LETEx15	POPR4=POPR415	DISP2=DISP215	
HELA5=HELA515	DIOLx=DIOLx15	DILI2=DILI215	SILIx=SILIx15; 
...
proc freq data=herbmerge2; tables bcat; run;
